...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueI18n = __webpack_require__(77);
	...
	var _module2 = __webpack_require__(193);
	  ...
	  (0, _createClass3.default)(I18n, [{
	    ...
	    value: function registerRouter() {
	      ...
	      this._router.beforeEach(function (to, from, next) {
	        var _store$getters = _this._store.getters;
	        var languages = _store$getters.languages;
	        var currentLanguage = _store$getters.currentLanguage;
	        var defaultCode = _store$getters.defaultCode;
	
	        var urlCode = to.params.lang;
	    ...
	    value: function registerModule() {
	      this._store.registerModule('i18n', _module3.default);
	    }
	        ...
	        return _regenerator2.default.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.next = 2;
	                return this._store.dispatch(_events.UPDATE_I18N_STATE, this._config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(104),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataView = __webpack_require__(159),
	    ...
	    baseGetTag = __webpack_require__(163),
	    toSource = __webpack_require__(106);
...
/***/ function(module, exports) {
	...
	var SET_TRANSLATION_ERROR = exports.SET_TRANSLATION_ERROR = 'SET_TRANSLATION_ERROR';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutations = __webpack_require__(194);
	
	var _mutations2 = _interopRequireDefault(_mutations);
	
	var _state = __webpack_require__(221);
	
	var _state2 = _interopRequireDefault(_state);
	
	var _getters = __webpack_require__(222);
	 ...
	 * @type {Object}
	 */
	exports.default = { state: _state2.default, mutations: _mutations2.default, getters: getters, actions: _actions2.default };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignIn = __webpack_require__(203);
	
	var _assignIn2 = _interopRequireDefault(_assignIn);
	
	var _storageHelper = __webpack_require__(220);
	...
	var mutations = (_mutations = {}, (0, _defineProperty3.default)(_mutations, _events.REMOVE_LANGUAGE_PERSISTENCY, function (state) {
	  state.persistent = false;
	}), (0, _defineProperty3.default)(_mutations, _events.SET_TRANSLATION, function (state, translations) {
	  ...
	  var language = (0, _find2.default)(languages, { code: code });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.defaultCode = exports.langUrlPrefix = exports.currentLanguage = exports.languages = undefined;
	...
	var languages = exports.languages = function languages(state) {
	  return state.languages;
	};
	
	var currentLanguage = exports.currentLanguage = function currentLanguage(state) {
	  return state.currentLanguage;
	};
	
	var langUrlPrefix = exports.langUrlPrefix = function langUrlPrefix(state) {
	  return state.currentLanguage.urlPrefix;
	};
	
	var defaultCode = exports.defaultCode = function defaultCode(state) {
	  var persistent = state.persistent;
	  var defaultCode = state.defaultCode;
	  var storageKey = state.storageKey;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _size = __webpack_require__(232);
	...
	exports.default = (_REMOVE_LANGUAGE_PERS = {}, (0, _defineProperty3.default)(_REMOVE_LANGUAGE_PERS, _events.REMOVE_LANGUAGE_PERSISTENCY, function (_ref) {
	  var commit = _ref.commit;
	
	  commit(_events.REMOVE_LANGUAGE_PERSISTENCY);
	}), (0, _defineProperty3.default)(_REMOVE_LANGUAGE_PERS, _events.UPDATE_I18N_STATE, function () {
	  var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref3, payload) {
	    var commit = _ref3.commit;
	    var state = _ref3.state;
	    var params, availableKeys, newKeys, parsedParams;
	    return _regenerator2.default.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	          ...
	          case 7:
	            params = _context.t0;
	            availableKeys = (0, _keys2.default)(state);
	            newKeys = params;
	
	            if (!((0, _size2.default)(newKeys) === 0)) {
	              _context.next = 12;
	              break;
	            }
	          ...
	          case 12:
	            parsedParams = (0, _pick2.default)(newKeys, availableKeys);
	
	
	            commit(_events.UPDATE_I18N_STATE, parsedParams);
	...
	}()), (0, _defineProperty3.default)(_REMOVE_LANGUAGE_PERS, _events.SET_TRANSLATION, function () {
	  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(_ref5, code) {
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            ...
	            language = (0, _find2.default)(languages, { code: code || defaultCode });
	            url = path + '/' + language.translateTo + '.json';
	            _context2.prev = 5;
	            _context2.next = 8;
	          ...
	          case 8:
	            ...
	            commit(_events.SET_TRANSLATION, data);
	...
	}()), (0, _defineProperty3.default)(_REMOVE_LANGUAGE_PERS, _events.CHANGE_LANGUAGE, function () {
	  var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(_ref8, code) {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 3:
	            ...
	            commit(_events.CHANGE_LANGUAGE, code);
	
	            _context3.next = 6;
	            return dispatch(_events.SET_TRANSLATION, code);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(176),
	    basePick = __webpack_require__(225),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseKeys = __webpack_require__(153),
	    ...
	    stringSize = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var asciiSize = __webpack_require__(235),
	    ...
	    unicodeSize = __webpack_require__(237);
...
/***/ function(module, exports) {
	...
	var log = exports.log = function log(text) {
	  ...
	  var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
	  ...
	  var warning = style + ' background: #f1e05a; color: #333333';
	  var error = style + ' background: #b9090b; color: #ffffff';
